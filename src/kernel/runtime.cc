...
TaskGraphResult print_task_graph(
  ...
  task_type_to_name[TASK_SPLITK_PARTIAL_LINEAR_SM100] =
      "TASK_SPLITK_PARTIAL_LINEAR_SM100";
  task_type_to_name[TASK_SPLITK_REDUCE_SM100] = "TASK_SPLITK_REDUCE_SM100";
  task_type_to_name[TASK_PREFILL_PROB_CAPTURE_SM100] =
      "TASK_PREFILL_PROB_CAPTURE_SM100";
